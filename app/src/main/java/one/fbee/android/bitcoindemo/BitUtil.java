...
//        return false? MainNetParams.get() : TestNet3Params.get();
//    }
//
//
...
//
//        //tobytes
//        byte[] bytes = MnemonicCode.toSeed(new ArrayList<String>(), passphrase);
//
//    }
//
...
//        System.out.println(privateKeyAsWiF+"=========="+s);
//    }
//
//
//
...
//
//    //通过助记词导入新钱包
//    public static Wallet importWalletFromMnemonicCode(String seedCode,String password) {
//        KeyChainGroup kcg;
...
//        WalletAppKit walletAppKit = new WalletAppKit(getParams(), context.getCacheDir(), "wallet") {
//            @Override
...
//                System.out.println(getPubKeyFrom(ecKey));
////                test2(ecKey);
////                //打印助记词
//                List<String> seedWordsFromWallet = getSeedWordsFromWallet(wallet());
//                System.out.println(seedWordsFromWallet.toString());
//                //当前地址
...
//                System.out.println("currentReceiveAddress="+s1+"===privateKeyAsWiF="+privateKeyAsWiF);
